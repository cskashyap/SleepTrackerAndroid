...
class SleepTrackerFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val viewModelFactory = SleepTrackerViewModelFactory(
        ...
        viewModel.showSnackbarEvent.observe(viewLifecycleOwner, Observer { shouldShow ->
            if (shouldShow == true) {
                Snackbar.make(
                ...
                viewModel.doneShowingSnackbarEvent()
            }
        })
